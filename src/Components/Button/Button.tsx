...
import React, { ComponentPropsWithRef, ElementType, forwardRef, memo } from "react";
    ...
    <T extends ElementType = "button">(
      ...
      return (
        <Component
          className={className}
          onClick={onClick}
          {...stylex.props(styles.button, is ? globalStyles.flex : globalStyles.flexButtons, style)}
          {...rest}
          ref={ref}
        >
          {children}
